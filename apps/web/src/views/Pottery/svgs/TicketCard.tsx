  ...
  return (
    <Svg viewBox="0 0 296 121" {...props}>
      <g filter="url(#filter0_dd_ticket_purchase_card)">
        <path d="M4 16C4 7.16344 11.1634 0 20 0H66V113H20C11.1634 113 4 105.837 4 97V16Z" fill="#E0E0E0" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="#E0E0E0"
        />
        <rect x="66" y="10" width="10" height="93" fill="#E0E0E0" />
        <path d="M78 103V10" stroke="#E0E0E0" strokeWidth="4" strokeDasharray="4 4" />
        <rect x="80" y="10" width="10" height="93" fill="#E0E0E0" />
        <path
          fillRule="evenodd"
          clipRule="evenodd"
          ...
          fill="#E0E0E0"
        />
        <path d="M90 0H276C284.837 0 292 7.16344 292 16V97C292 105.837 284.837 113 276 113H90V0Z" fill="#E0E0E0" />
      </g>
      <defs>
        <filter
