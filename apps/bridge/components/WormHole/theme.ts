...
export const wormHoleDarkTheme = {
  primary: {
    '50': lightenColor('#8A8D8F', 0.9),
    '100': lightenColor('#8A8D8F', 0.8),
    '200': lightenColor('#8A8D8F', 0.7),
    '300': lightenColor('#8A8D8F', 0.6),
    '400': lightenColor('#8A8D8F', 0.5),
    '500': lightenColor('#8A8D8F', 0.4),
    '600': lightenColor('#8A8D8F', 0.3),
    '700': lightenColor('#8A8D8F', 0.2),
    '800': lightenColor('#8A8D8F', 0.1),
    '900': '#8A8D8F',
    A100: lightenColor('#8A8D8F', 0.8),
    A200: lightenColor('#8A8D8F', 0.7),
    A400: lightenColor('#8A8D8F', 0.5),
    A700: lightenColor('#8A8D8F', 0.2),
  },
  secondary: {
  ...
  card: { background: '#8A8D8F', secondary: '#372f46', elevation: '5px 5px 15px 5px rgb(33,34,68)' },
  popover: { background: '#8A8D8F', secondary: '#372f46', elevation: '5px 5px 15px 5px rgb(33,34,68)' },
...
export const wormHoleLightTheme = {
  ...
  text: { primary: '#280D5F', secondary: '#333333' },
  error: {
    '50': lightenColor('#ED4B9E', 0.9),
    '100': lightenColor('#ED4B9E', 0.8),
    '200': lightenColor('#ED4B9E', 0.7),
